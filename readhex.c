...
struct pics_data
{
    ...
    unsigned id_addr;
    unsigned last_addr;
    unsigned config_mask_1; // Mask with valid bits in configuration word 1
    unsigned config_mask_2; // Mask with valid bits in configuration word 2
} pic_list[] =
{
    { " 1: PIC12F675",  0x0FC0, 0xFFE0, 0x0400, 0x2000, 0x2008, 0x01FF, 0x0000},
    { " 2: PIC12F1571", 0x3051, 0xFFFF, 0x0400, 0x8000, 0x8009, 0x0EFB, 0x3F03},
    { " 3: PIC12F1572", 0x3050, 0xFFFF, 0x0800, 0x8000, 0x8009, 0x0EFB, 0x3F03},
    { " 4: PIC16F88",   0x0760, 0xFFE0, 0x1000, 0x2000, 0x2008, 0x3FFF, 0x0003},
    { " 5: PIC16F636",  0x10a0, 0xFFE0, 0x0800, 0x2000, 0x2008, 0x1FFF, 0x0000},
    { " 6: PIC16F690",  0x1400, 0xFFE0, 0x1000, 0x2000, 0x2008, 0x0FFF, 0x0000},
    { " 7: PIC16F1454", 0x3020, 0xFFFB, 0x2000, 0x8000, 0x8009, 0x3EFF, 0x3FF3},
    { " 8: PIC16F1455", 0x3021, 0xFFFB, 0x2000, 0x8000, 0x8009, 0x3EFF, 0x3FF3},
    { " 9: PIC16F1459", 0x3023, 0xFFFB, 0x2000, 0x8000, 0x8009, 0x3EFF, 0x3FF3},
    { "10: PIC16F1847", 0x1480, 0xFFE0, 0x2000, 0x8000, 0x8009, 0x3FFF, 0x3703},
    { "11: PIC16F1936", 0x2360, 0xFFE0, 0x2000, 0x8000, 0x8009, 0x3FFF, 0x3733}
};
